...
QtObject {
		...
		readonly property color inverse_primary: "#0c6780"
		...
		readonly property color on_primary_container: "#baeaff"
	
		readonly property color on_primary_fixed: "#001f29"
	
		readonly property color on_primary_fixed_variant: "#004d62"
		...
		readonly property color on_secondary_fixed_variant: "#354a53"
		...
		readonly property color on_tertiary_fixed_variant: "#444465"
		...
		readonly property color primary_fixed: "#baeaff"
	
		readonly property color primary_fixed_dim: "#89d0ed"
		...
		readonly property color secondary_fixed_dim: "#b3cad5"
	
		readonly property color shadow: "#000000"
	
		readonly property color source_color: "#29bce8"
		...
		readonly property color surface_tint: "#89d0ed"
		...
		readonly property color tertiary_fixed_dim: "#c4c3eb"
