...
def main():
    ...
    parser.add_argument("--auto-hide", choices=["true", "false"], help="Auto-hide island when inactive")
    ...
    if args.auto_hide is not None:
        config['islandAutoHideEnabled'] = (args.auto_hide.lower() == "true")
