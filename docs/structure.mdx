...
description: Learn how the HyprDots repository is organized and what each folder contains.
---

This page maps the HyprDots repository and explains the responsibilities of each folder.
...
That makes HyprDots easy to customize and maintain.
